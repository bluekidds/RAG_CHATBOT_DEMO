...
def get_loader(file_name) :
    ...
    if (file_type == 'pdf') :
        ...
        return Docx2txtLoader(full_path)
    elif (file_type == 'doc'):
        return UnstructuredWordDocumentLoader(full_path)
    else :
        return None
...
def load_documents():
    ...
    for file_name in files:
        ...
        # loader = Docx2txtLoader(os.path.join(directory_path, file_name))
